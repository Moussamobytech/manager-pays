...
export class HomeComponent implements OnInit {
  ...
  public slides = [
    ...
    { title: 'BIENVENUE SUR FIDELITY MARKET', subtitle: 'Trouvez ce qui vous intéresse et contactez le vendeur en un clic. Vous êtes commerçant ? Créez votre compte et publier vos produits gratuiement!', image: 'assets/images/ads/5.jpg', /*show: 'Créer un compte',*/ },
