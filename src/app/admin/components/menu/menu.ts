...
export const menuItems = [
    ...
    new Menu (160, 'Commandes', '/admin/commande', null, 'shop', null, false, 0),
     new Menu (160, 'Vendeur', '/admin/vendors', null, 'storefront', null, false, 0),
    // new Menu (21, 'ADMIN_NAV.CATEGORIES', '/admin/products/categories', null, 'category', null, false, 0),
    ...
    new Menu (168, 'Paiements', '/admin/paiement', null, 'money', null, false, 0),
