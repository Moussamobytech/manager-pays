...
export const menuItems = [
    ...
    new Menu (130, 'ADMIN_NAV.BRAND', '/admin/brand/brand-list', null, 'grid_on', null, false, 0),
    new Menu (140, 'ADMIN_NAV.CAMPAGNE', '/admin/campagne/campagne-list', null, 'more_horiz', null, false, 0),
