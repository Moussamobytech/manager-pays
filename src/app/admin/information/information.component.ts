...
export class InformationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.infoForm = this.formBuilder.group({
      ...
      'points': [this.currentUser.points || null]
    });
  ...
  // public async onPasswordFormSubmit(values:Object):Promise<void> {
  //   console.log(":::::::PAss ", this.passwordForm)
  //   if (this.passwordForm.valid && this.passwordForm.value.newPassword)  {
  //     let data : any = values;
  //     console.log("::: update ", data)
  //     // data.type = this.currentProfile(values["profiles"])
  //     // sconsole.log("::: update 11")
  //     console.log("::: update json", JSON.stringify(data))

  //     let res = await this.auth.updatePassword(data)
  //     console.log("::: update 3", res)
