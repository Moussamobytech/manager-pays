...
const routes: Routes = [
  {
      ...
      component: PagesComponent, children: [
          ...
          { path: 'account-seller', loadChildren: () => import('./pages/account-seller/account.module').then(m => m.AccountSellerModule), data: { breadcrumb: 'Compte vendeur' } },
          { path: 'account-customer', loadChildren: () => import('./pages/account-customer/account.module').then(m => m.AccountCustomerModule), data: { breadcrumb: 'Mon compte' } },
          ...
          { path: 'referal', loadChildren: () => import('./pages/referral/referral.module').then(m => m.ReferralModule), data: { breadcrumb: 'Parrainage' } },
          { path: 'promo', loadChildren: () => import('./pages/promo/promo.module').then(m => m.PromoModule), data: { breadcrumb: 'Promo' } },
          { path: 'authentication', loadChildren: () => import('./pages/session/session.module').then(m => m.SessionModule), data: { breadcrumb: 'Authentification' } },
      ]
  },
